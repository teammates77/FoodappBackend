...
@CircuitBreaker(name = "FOODCART-SERVICE", fallbackMethod = "fallbackMethod")
...
public ResponseEntity<String> fallbackMethod(@RequestBody RegistrationDTO registrationDTO , RuntimeException ex) {
